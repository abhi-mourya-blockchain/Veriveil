...
export const PrivacyRadar: React.FC = () => {
  return (
    <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-gold-500/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-2xl bg-midnight-900/80 border border-slate-700/60 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-slate-800 mb-4">
              ...
              <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded bg-cyan-950/60 text-cyan-300 border border-cyan-500/30">
                Visible to All
              </span>
            </div>
        ...
        <div className="p-5 rounded-2xl bg-midnight-900/80 border border-gold-500/30 shadow-gold-glow flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-gold-500/20 mb-4">
              ...
              <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded bg-gold-950/60 text-gold-300 border border-gold-500/30">
                100% Confidential
              </span>
            </div>
            ...
            <ul className="space-y-3 text-xs text-slate-300">
              <li className="flex items-start gap-2.5">
                <EyeOff className="w-4 h-4 text-gold-400 mt-0.5 flex-shrink-0" />
                <div>
                  <strong className="text-gold-200">Exact Sealed Bid Amount:</strong>
              ...
              <li className="flex items-start gap-2.5">
                <EyeOff className="w-4 h-4 text-gold-400 mt-0.5 flex-shrink-0" />
                <div>
                  <strong className="text-gold-200">Cryptographic Salt Entropy:</strong>
              ...
              <li className="flex items-start gap-2.5">
                <EyeOff className="w-4 h-4 text-gold-400 mt-0.5 flex-shrink-0" />
                <div>
                  <strong className="text-gold-200">Bidder Private Key (SK):</strong>
              ...
              <li className="flex items-start gap-2.5">
                <EyeOff className="w-4 h-4 text-gold-400 mt-0.5 flex-shrink-0" />
                <div>
                  <strong className="text-gold-200">Losing Bid Amounts:</strong>
          ...
          <div className="mt-6 pt-4 border-t border-gold-500/20 text-[11px] text-gold-400 flex items-center justify-between">
